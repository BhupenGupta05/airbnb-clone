...
const AccountNav = () => {
  ...
  return (
    <nav className="flex justify-center gap-4 w-full mt-8 mb-8">
            ...
            <Link className={selectClasses('bookings')} to={'/account/bookings'}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={16} height={16} className={subpage === 'bookings' ? 'text-white' : ''}>
            ...
            <Link className={selectClasses('places')} to={'/account/places'}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={16} height={16} className={subpage === 'places' ? 'text-white' : ''}>
